...
# Streamlit app
st.set_page_config(
    page_title="Hệ thống giám sát tập trung học sinh", 
    layout="centered",
    page_icon="",
...
st.title("Hệ thống giám sát tập trung học sinh")
st.markdown("Phát hiện ngủ gật và mất tập trung của học sinh bằng thị giác máy tính.")

# PWA Installation Instructions
with st.expander("Cài đặt ứng dụng trên điện thoại", expanded=False):
    st.markdown("""
